...
export class WorldUtils {
  ...
  static getBiomeType(
    ...
    entity.remove();
    return this.biome2Name(biome, biomeMap);
  }
   ...
   * @returns {boolean}
   */
  static trySetBlockType(dimension: Dimension, location: Vector3, block: string): boolean {
    return ErrorUtils.wrapCatchSingle(LocationInUnloadedChunkError, () =>
