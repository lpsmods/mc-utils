...
import { ActionForm, ActionFormEvent, ActionFormHandler } from "../ui/ActionForm";
import { ModalForm, ModalFormHandler } from "../ui/ModalForm";
...
export class WritableBookComponent {
  static typeId = "mcutils:writable_book";
  MAX_PAGES = 50;
